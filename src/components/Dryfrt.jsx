...
const products = [
  {
    ...
    price: "₹750",
    oldPrice: "₹1299",
    image: "https://tekisky-mart.s3.ap-south-1.amazonaws.com/images/1709378356084_cashew_nuts___kaju_a__content.jpg"
  },
  {
    name: "Nutlife Walnu...",
    price: "₹230",
    oldPrice: "₹425",
    image: "https://tekisky-mart.s3.ap-south-1.amazonaws.com/images/1709378980890_walnuts1.webp"
  },
  {
    name: "flash pods pr...",
    price: "₹499",
  ...
  return (
    <div className="p-4">
      ...
      <div className="flex justify-between bg-gray-200 items-center border-b p-2 mb-4">
        <h2 className="text-xl font-bold">सूखे मेवे</h2>
        <h2 className="text-xl font-bold">DRY FRUITS</h2>
        <h2 className="text-xl font-bold">خشک میوہ جات</h2>
      </div>
